...
void handle_display_event(
    ...
    */
    ...
    std::cout << "At Time: " << system_time << std::endl;
    std::cout << "Available Main Memory: " << available_memory << std::endl;
    std::cout << "Current Devices: " << available_devices << std::endl;
   ...
   std::cout<< "Job ID\tWaiting Time\tTime Left" << std::endl;
   std::cout<< "-------\t------------\t---------" << std::endl;
   ...
   std::cout<< CPU.pid << "\t" << CPU.waiting_time<< "\t\t" << CPU.finished_time << std::endl;
   ...
   std::cout<< "Job ID\tRun Time\tWaiting Time" <<std::endl;
   std::cout<< "-------\t--------\t-------------" <<std::endl;
    ...
    for (int i = 0; i < ReadyQueue.size(); i++) {
       ...
       std::cout<< process.pid << "\t" << process.run_time << "\t\t" << process.waiting_time <<std::endl;
    }
   ...
   std::cout<< "Job ID\tArrival Time\tFinish Time\tTurnaround Time" <<std::endl;
   std::cout<< "-------\t------------\t-----------\t---------------" <<std::endl;
    // print the pid, state, time slice, run time, memory requirement, device requirement, finished, start time, turnaround time, and waiting time for each process
    for (int i = 0; i < CompleteQueue.size(); i++) {
        Process process = CompleteQueue[i];
       std::cout<< process.pid << "\t" << process.start_time << "\t\t" << process.finished_time << "\t\t" << process.turnaround_time <<std::endl;
    }

   std::cout<< "System Turnaround Time: " << CPU.turnaround_time <<std::endl;
